...
import sys
sys.path.append("GlobalStateEvaluation")
import test
sys.path.append("MSC/data_loader")
import BatchEnv
...
# import function above is outdated. Replaced with importlib below
#importlib.import_module("Baselines.GlobalStateEvaluation.test", package = "Baselines")
