...
with open("reward.txt", 'rU') as f:
	...
	plt.plot(win_so_far, percetage_win_so_far, "b", loss_so_far, percetage_loss_so_far, "r", tie_so_far, percetage_tie_so_far, "g")
	plt.title("SupremeBot Learning Trend Graph")
